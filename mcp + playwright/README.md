...
מערכת צ'אט מבוססת AI שעונה בעברית על שאלות לגבי מזג האוויר בערים בישראל - בזמן אמת, על ידי גלישה עצמאית באתר תחזית ישראלי (ולא באמצעות API חיצוני).


## 🎯 מטרת הפרויקט

הפרויקט נועד להתנסות בבניית MCP Server עצמאי, ובהוספת יכולות שליטה בדפדפן ל-LLM באמצעות Playwright. הבחירה לגשת לאתר ישירות (במקום להשתמש ב-API רשמי) נועדה לתרגל תרחיש מציאותי בו אין מקור מידע מובנה זמין, ויש "לדמות" משתמש אנושי שגולש בעצמו..
## 🧩 מבנה הפרויקט
